...
// Companion to bcc32_resident_factor_basins.cuh, split out exactly as
// bcc32_resident_edge_bank_tissue.cuh is split from
// bcc32_resident_edge_bank.cuh: this file depends on the full GrownAdult
// definition (physical_slot(), StateEntry, attach_founder_matter()) so it
// cannot be included FROM bcc32_developmental_adult.cuh itself without a
// cycle. Only test/consumer code includes this file.
namespace substrate::bcc32::resident_factor_basins_tissue {
