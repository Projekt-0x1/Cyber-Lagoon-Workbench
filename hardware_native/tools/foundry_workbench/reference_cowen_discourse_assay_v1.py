...
PUBLIC_RECEIPT = ROOT / "cowen_discourse_assay_v1_public.json"
...
def main():
    ...
    public_receipt = {
        "schema": "0x1.cowen-discourse-assay-public.v1",
        "runtime_llm": False,
    ...
    result = {
        "schema": "0x1.reference-cowen-discourse-assay.v1",
        "pass": passed,
        "checks": checks,
        "runtime_llm": False,
        "host_expected_output": False,
        ...
        "claim": (
            ...
            "REUSES_BOTH_AFTER_DELAY_AND_RETURNS_TO_UNCERTAINTY_AFTER_COUNTEREVIDENCE_"
